...
def normalise_input(user_input):
    ...
    'help'
    """
    nopunct_input = remove_punct(user_input)
    no_lr_space = remove_spaces(nopunct_input)
    output = no_lr_space.lower()
    return output
...
def menu(exits):
    ...
    while True:
        ...
        # Display menu
        print_menu(exits)
        # Read player's input and normalise
        y = normalise_input(input("Which direction will you move: "))
        if is_valid_exit(exits, y) == True:
            return y
